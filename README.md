...
[![Telegram](https://img.shields.io/badge/Telegram-@jfd_jgd-26A5E4?style=flat-square&logo=telegram&logoColor=white)](https://t.me/jfd_jgd)
...
### 🧱 Новое в версии 2.0.0 - Улучшенное размещение

Теперь камнерез можно ставить **на стены** и **на потолок**!  
Как в модах на дополнительное размещение блоков (вроде *Additional Placements*), но только для камнереза.

*При этом:*
- Настенный и потолочный камнерез **полностью сохраняет урон**.
- Механика работает пока что только на версиях [![Fabric](https://img.shields.io/badge/Fabric-yellow?logo=fabric&logoColor=white)](https://fabricmc.net/) и [![NeoForge](https://img.shields.io/badge/NeoForge-1.21.11-red?logo=curseforge&logoColor=white)](https://neoforged.net/)
